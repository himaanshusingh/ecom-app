  ...
  return (
    <div className='w-[100%] md:h-[36vh] h-[21vh] mb-[77px] md:mb-[0px]'>
        <div className='w-[100%] md:h-[30vh] h-[15vh]  md:mb-[0px]  flex items-center justify-center md:px-[50px] px-[5px]'>
            <div className='md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]  mt-0'>
                <div className='flex items-start justify-start gap-[5px] mt-[5px] md:mt-[40px]'>
                    <img src={logo} alt=""  className='md:w-[40px] md:h-[40px] w-[20px] h-[20px] rounded-lg'/>
                    <p className='text-[19px] md:text-[20px] text-[black] '>OneCart</p>
            
                </div>
                <p className='text-[15px] text-[#1e2223] hidden md:block'>coCart is your all-in-one online shopping destination, offering top-quality products, unbeatable deals, and fast delivery—all backed by trusted service designed to make your life easier every day.</p>
        ...
        <div className='w-[100%] h-[1px] bg-slate-400 mt-4'></div>

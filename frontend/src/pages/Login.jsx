...
const Login = () => {
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex flex-col text-[white] items-center justify-start">
      <div
        className="w-[100%] h-[80px] flex items-center justify-start text-[25px] font-sans gap-[10px] cursor-pointer"
        onClick={() => navigate("/")}
      >
      ...
      <div
        className="w-[100%] h-[80px] flex items-center justify-center flex-col gap-[7px]"
        onClick={handleLogin}
      >
      ...
      <div className="max-w-[500px] w-[90%] h-[400px] border-[1px] border-[#96969635] bg-[#00000025] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center">
        ...
        >
          <div
            className="w-[100%] h-[50px] bg-[#42656cae] flex items-center justify-center gap-[10px] p-[20px] cursor-pointer rounded-lg"
            onClick={googlelogin}
          >
          ...
          <div className=" w-[100%] h-[1px] flex items-center justify-center gap-[20px]">
            <div className="w-[50%] h-[1px] bg-[#96969635]"></div> Or{" "}
            <div className="w-[50%] h-[1px] bg-[#96969635]"></div>
          </div>

          <div className="w-[90%] h-[300px] flex flex-col items-center justify-center gap-[10px] relative">
            <input
              type="email"
              className="w-[100%] h-[50px] border-[2px] border-[#96969635] rounded-lg backdrop:blur-sm bg-transparent placeholder-[white] font-semibold p-[10px]"
              placeholder="Email"
              required
            ...
            {!show && (
              <FaEye
                className="w-[20px] h-[20px] absolute right-[5%]  mb-[25px]"
            ...
            <button className="w-[100%] h-[40px] mt-[15px] bg-[#6060f5] flex items-center justify-center rounded-lg">
              Login
            </button>

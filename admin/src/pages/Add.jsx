             ...
             <div  className='w-[100%] h-[100%] flex items-center justify-start '>
              <p className='text-[20px] md:text-[25px]  font-semibold'>
                ...
                <div className='w-[100%] h-[100%] flex items-center justify-start '>
                  ...
                  <img src={!image1 ? uploadImage : URL.createObjectURL(image1)} alt='' className='w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px]'/>
                  ...
                  <img src={!image2 ? uploadImage : URL.createObjectURL(image2)} alt='' className='w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px]'/>
                  ...
                  <img src={!image3 ? uploadImage : URL.createObjectURL(image3)} alt='' className='w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px]'/>
                  ...
                  <img src={!image4 ? uploadImage : URL.createObjectURL(image4)} alt='' className='w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px]'/>
